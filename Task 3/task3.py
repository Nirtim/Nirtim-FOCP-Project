...
class PasswordManager:
    PASSWORD_FILE = "/Users/nirtimbhandari/Documents/FOCP Project & Exercise/FOCP Project/passwd.txt"
    ...
    def encrypt_password(password):
        # You can use a stronger encryption algorithm if needed.
    ...
    def change_password(self):
        ...
        if user_info is not None and user_info[2] == current_password:
            ...
            if new_password == confirm_password:
                # Find the index of the line in the 'lines' list
                index = self.lines.index(":".join(user_info))

                # Update the password in the 'lines' list
